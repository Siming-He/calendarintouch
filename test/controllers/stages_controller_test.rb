...
class StagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stage" do
    assert_difference('Stage.count') do
      post stages_url, params: { stage: { done: @stage.done, end: @stage.end, name: @stage.name, start: @stage.start, task_id: @stage.task_id } }
    end
  ...
  test "should update stage" do
    patch stage_url(@stage), params: { stage: { done: @stage.done, end: @stage.end, name: @stage.name, start: @stage.start, task_id: @stage.task_id } }
